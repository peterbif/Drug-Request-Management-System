  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllFabricss' + '?token=' + _this2.$store.state.token).then(function (response) {
                  _this2.allFabricss = response.data.allFabricss;
                  _this2.allFabrics2 = response.data.allFabricss2;
                  _this2.totalFabricss = response.data.totalFabricss;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return _this4.form.post('api/fabricss' + '?token=' + _this4.$store.state.token).then(function () {
    ...
    updateFabrics: function updateFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this5.form.put('api/Fabricss/' + _this5.form.id + '?token=' + _this5.$store.state.token).then(function () {
    ...
    deleteFabrics: function deleteFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this6.form["delete"]('api/fabricss/' + item.id + '?token=' + _this6.$store.state.token).then(function () {
