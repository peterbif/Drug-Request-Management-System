                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    { attrs: { cols: "12", sm: "6", md: "6" } },
                                    [
                                      _vm.form.errors.has("date_of_appointment")
                                        ? _c(
                                            "v-alert",
                                            {
                                              attrs: {
                                        ...
                                        directives: [
                                          {
                                            name: "show",
                                            rawName: "v-show",
                                            value: _vm.show_date_of_resumption,
                                            expression:
                                              "show_date_of_resumption",
                                          },
                                        ],
                                        staticClass: "mb-3",
                                        attrs: {
                                          required: "",
                                          rules: _vm.dateOfResumptionRule,
                                        },
                                        model: {
