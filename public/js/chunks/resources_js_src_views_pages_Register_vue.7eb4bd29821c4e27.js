          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _this.form.post('/api/auth/register').then(function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.dataSpinnerLoading = true;
                _context2.next = 3;
                return axios.get("/api/auth/allDepts").then(function (response) {
                  _this2.count = response.data.depts;
                  _this2.deptReport = response.data.deptReport;

                  // this.count = this.depts.reduce((counter, obj) => obj.department != '' ? counter += 1 : counter, 0); 

                  _this2.dataSpinnerLoading = false;
                })["catch"](function () {
                  // this.$toastr.error("Can not count total depts", "Error");
                  _this2.dataSpinnerLoading = true;
                });
              case 3:
              case "end":
