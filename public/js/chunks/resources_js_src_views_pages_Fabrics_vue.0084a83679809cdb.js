  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('/api/allStatuses').then(function (response) {
                  _this2.statuses = response.data.allStatuses;
                })["catch"](function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllFabricss' + '?token=' + _this4.$store.state.token).then(function (response) {
                  _this4.allFabricss = response.data.allFabricss;
                  _this4.allFabrics2 = response.data.allFabricss2;
                  _this4.totalFabricss = response.data.totalFabricss;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _this6.form.grand_price = parseFloat(_this6.form.grand_price);
                _this6.form.payment = parseFloat(_this6.form.payment);
                _context5.next = 5;
                return _this6.form.post('api/Fabricss' + '?token=' + _this6.$store.state.token).then(function () {
    ...
    updateFabrics: function updateFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this7.form.put('api/Fabricss/' + _this7.form.id + '?token=' + _this7.$store.state.token).then(function () {
            ...
            _this7.btn2 = '';
            _this7.$toastr.error('Can not update Fabrics information', 'Error');
          });
        }
      });
    },
    deleteFabrics: function deleteFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this8.form["delete"]('api/Fabricss/' + item.id + '?token=' + _this8.$store.state.token).then(function () {
