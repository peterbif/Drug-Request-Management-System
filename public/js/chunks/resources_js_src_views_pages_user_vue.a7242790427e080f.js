...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateStaff: function updateStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this5.form.put("api/staffs/" + item.id + '?token=' + _this5.$store.state.token).then(function () {
    ...
    passportUpload: function passportUpload() {
      this.dialog2 = true;
    },
    ...
    createPassport: function createPassport() {},
