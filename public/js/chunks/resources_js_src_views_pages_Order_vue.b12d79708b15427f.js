...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getText: function getText(item) {
      "".concat(item.surname, " - ").concat(item.text);
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllCustomers' + '?token=' + _this3.$store.state.token).then(function (response) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllOrders' + '?token=' + _this4.$store.state.token).then(function (response) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return _this6.form.post('api/Orders' + '?token=' + _this6.$store.state.token).then(function () {
    ...
    updateOrder: function updateOrder(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this7.form.put("api/Orders/" + _this7.form.id + '?token=' + _this7.$store.state.token).then(function () {
            _this7.$toastr.success("Order updated successfully", "Success");
            Fire.$emit("updatedOrderEvent"); //update an event
            _this7.dialog = false;
          })["catch"](function (error) {
            _this7.btn = "Updating Order";
            _this7.btn2 = "";
            _this7.$toastr.error("Can not update Order information", "Error");
          });
        }
      });
    },
    deleteOrder: function deleteOrder(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this8.form["delete"]("api/Orders/" + item.id + '?token=' + _this8.$store.state.token).then(function () {
