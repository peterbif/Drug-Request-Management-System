  ...
  methods: {
    ...
    updateStaff: function updateStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this4.form.put("api/auth/staffs/" + item.id + '?token=' + _this4.$store.state.token).then(function () {
            _this4.$toastr.success("dept updated successfully", "Success");
            Fire.$emit("updatedeptEvent"); //update an event
            _this4.hideModal();
            _this4.spinnerLoading = false;
            // window.location="/dept";
          })["catch"](function (error) {
            _this4.btn = "Updating dept";
            _this4.spinnerLoading = true;
            _this4.btn2 = "";
            _this4.$toastr.error("Can not update dept information", "Error");
          });
        }
      });
    },
    deleteStaff: function deleteStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this5.form["delete"]("api/auth/staffs/" + dept.id + '?token=' + _this5.$store.state.token).then(function () {
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllStaff").then(function (response) {
                  _this6.getAllStaff = response.data.getAllStaff;
                ...
                return [
                  ...
                  _c(
                    "v-icon",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          return _vm.deleteStaff(item.id)
                        },
                      },
                    },
                    [_vm._v("mdi-delete")]
