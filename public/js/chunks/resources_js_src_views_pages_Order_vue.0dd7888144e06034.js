  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllOrders' + '?token=' + _this6.$store.state.token).then(function (response) {
                  _this6.allOrders = response.data.allOrders;
                  _this6.allOrder2 = response.data.allOrders2;
                  _this6.totalOrders = response.data.totalOrders;
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
              case 2:
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                .then(function (response) {
                  _this7.allOrders = response.data.allOrders;
                })["catch"](function () {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 3;
                return _this8.form.post('api/Orders' + '?token=' + _this8.$store.state.token).then(function () {
    ...
    updateOrder: function updateOrder(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this9.form.put("api/Orders/" + _this9.form.id + '?token=' + _this9.$store.state.token).then(function () {
            _this9.$toastr.success("Order updated successfully", "Success");
            Fire.$emit("updatedOrderEvent"); //update an event
            _this9.dialog = false;
          })["catch"](function (error) {
            _this9.btn = "Updating Order";
            _this9.btn2 = "";
            _this9.$toastr.error("Can not update Order information", "Error");
          });
        }
      });
    },
    deleteOrder: function deleteOrder(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this10.form["delete"]("api/Orders/" + item.id + '?token=' + _this10.$store.state.token).then(function () {
