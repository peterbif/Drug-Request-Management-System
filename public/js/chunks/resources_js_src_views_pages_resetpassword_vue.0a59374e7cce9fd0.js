          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _this3.form.post('api/auth/login').then(function (response) {
                  if (response.data.status) {
                    _this3.$store.commit('setToken', response.data.token);
                    _this3.$toastr.success("login successfully", "Success");
                    _this3.$router.push('/dashboard');
                    _this3.form.reset();
                  }
                })["catch"](function (error) {
                  // this.spinnerLoading = true;
                  _this3.$toastr.error("Can not login", error);
                });
              case 3:
              case "end":
                      ...
                      _c(
                        "v-btn",
                        {
                          ...
                          attrs: {
                            ...
                            color: "primary",
                            disabled: !(
                              _vm.form.secret_question_id && _vm.form.password
                            ),
                          },
                          on: { click: _vm.login },
                        },
