...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return _ref = {
      ...
      columns: [{
        ...
        field: 'Fabrics_contact.contact_address'
      }, {
        label: 'Email',
        field: 'Fabrics_contact.email'
      }, {
        label: 'Phone No',
        field: 'Fabrics_contact.phone_no'
      }],
      btn: '',
      btn2: '',
      dialog: false,
  ...
  methods: {
    ...
    //           return obj.id === item.Fabrics_contact.state_of_origin_id;
    //       });
    //    return   this.state_of_origin = this.states[index].state;
    // },
    // stateOfResidence(item){
    //   const index =  this.states.findIndex(function(obj) {
    //           return obj.id === item.Fabrics_contact.state_of_residence_id;
    //       });
    ...
    getAllFabricss: function getAllFabricss() {
      var _this8 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllFabricss' + '?token=' + _this8.$store.state.token).then(function (response) {
                  _this8.allFabricss = response.data.allFabricss;
                  _this8.allFabrics2 = response.data.allFabricss2;
                  _this8.totalFabricss = response.data.totalFabricss;
    ...
    // async getAllFabricss() {
    //   await axios.get('api/getAllFabricss'+'?token='+this.$store.state.token)
    //     .then((response) => {
    //        this.allFabricss = response.data.allFabricss;
    //     })
    //     .catch(() => {
    //       // this.$toastr.error("Can not load status", "Error");
    //     });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                query = _this9.search;
                _this9.form.post('/api/search/Fabrics')
                // .get('api/auth/findDesignation?q='+ query + '&token=' + this.$store.state.token )
                .then(function (response) {
                  _this9.allFabricss = response.data.allFabricss;
                  _this9.allFabrics2 = response.data.allFabricss2;
                  _this9.totalFabricss = response.data.totalFabricss;
                  // this.amounts = response.data.amount;
                })["catch"](function () {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 5;
                return _this10.form.post('api/Fabricss' + '?token=' + _this10.$store.state.token).then(function () {
    ...
    editFabrics: function editFabrics(item) {
      ...
      this.form.grand_price = item.Fabrics_payment.grand_price;
      this.form.Fabrics_payment_id = item.Fabrics_payment.id;
      this.form.payment = item.Fabrics_payment.payment;
      this.dialog = true;
    },
    updateFabrics: function updateFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this11.form.put('api/Fabricss/' + _this11.form.id + '?token=' + _this11.$store.state.token).then(function () {
            _this11.$toastr.success('Fabrics updated successfully', 'Success');
            Fire.$emit('updatedFabricsEvent'); //update an event
            _this11.dialog = false;
          })["catch"](function (error) {
            _this11.btn = 'Updating Fabrics';
            _this11.btn2 = '';
            _this11.$toastr.error('Can not update Fabrics information', 'Error');
          });
        }
      });
    },
    deleteFabrics: function deleteFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this12.form["delete"]('api/Fabricss/' + item.id + '?token=' + _this12.$store.state.token).then(function () {
...
/***/ "./resources/js/src/views/pages/Fabrics.vue?vue&type=custom&index=0&blockType=v-row&justify=center":
/*!*********************************************************************************************************!*\
  !*** ./resources/js