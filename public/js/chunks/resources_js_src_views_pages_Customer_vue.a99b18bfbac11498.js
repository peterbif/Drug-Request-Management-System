...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    view: function view(item) {
      ...
      this.staff_category = item.staffcategory.name;
    },
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllStaff").then(function (response) {
                  ...
                  _this2.allStaff2 = response.data.allstaff2;
                  _this2.totalStaff = response.data.totalStaff;
