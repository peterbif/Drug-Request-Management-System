...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    view: function view(item) {
      this.dialog3 = true;
      this.form.fill(item);
      this.form.email = item.customer_contact.email;
      this.form.phone_no = item.customer_contact.phone_no;
      this.form.contact_address = item.customer_contact.contact_address;
      this.form.state_of = item.customer_contact.phone_no;
      this.form.phone_no = item.customer_contact.phone_no;

      //  this.state_of_residence = item.customer_contact.state_of_residence_id;
      //  this.state_of_origin =  item.customer_contact.state_of_origin_id;

      this.form.state_of_residence_id = item.customer_contact.state_of_residence_id;
      ths.form.state_of_origin_id = item.customer_contact.state_of_origin_id;
      this.form.customer_id = item.customer_contact.id;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllCustomers' + '?token=' + _this5.$store.state.token).then(function (response) {
                  _this5.allCustomers = response.data.allCustomers;
                  //  this.allCustomer2 = response.data.allCustomers2;
                  _this5.totalCustomers = response.data.totalCustomers;
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
              case 2:
        ...
        scopedSlots: _vm._u([
          {
            ...
            fn: function () {
              return [
                ...
                _c(
                  "tbody",
                  _vm._l(_vm.allCustomers, function (item, index) {
                    return _c("tr", { key: item.id }, [
                      ...
                      _c("td", { staticClass: "text-left" }, [
                        _vm._v(_vm._s(item.customer_contact.email)),
                      ]),
                      _vm._v(" "),
                      _c("td", { staticClass: "text-left" }, [
                        _vm._v(_vm._s(item.customer_contact.phone_no)),
                      ]),
                      _vm._v(" "),
                      _c(
                        "td",
