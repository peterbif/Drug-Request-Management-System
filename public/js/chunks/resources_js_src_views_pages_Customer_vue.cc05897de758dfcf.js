...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      dialog3: false,
      Customer_category: "",
      totalCustomer:  false || 0,
      // date_of_appointment: (new Date(Date.now() - (new Date()).getTimezoneOffset() * 60000)).toISOString().substr(0, 10),

      form: new Form((0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({
        id: "",
        surname: "",
        firstname: "",
  ...
  setup: function setup() {
    ...
    var Customer_categories = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)([]);
    var socialLink = [{
  ...
  methods: {
    ...
    view: function view(item) {
      ...
      // this.Customer_category = item.Customercategory.name
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/getStates").then(function (response) {
                  _this4.states = response.data.states;
                })["catch"](function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/getAllCustomers").then(function (response) {
                  _this5.allCustomer = response.data.allCustomer;
                  _this5.allCustomer2 = response.data.allCustomer2;
                  _this5.totalCustomer = response.data.totalCustomer;
                  // response.data.allCustomerCategories.forEach((Object) => {
                  //   this.Customer_categories.push({ value: Object.id, label: Object.name});
                  // });
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                query = _this6.search;
                _context3.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('/api/search/Customer?s=' + query)
                // .get('api/auth/findDesignation?q='+ query + '&token=' + this.$store.state.token )
                .then(function (response) {
                  _this6.allCustomer = response.data.allCustomer;
                })["catch"](function () {
    ...
    createCustomer: function createCustomer() {
      var _this7 = this;
      return (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee4() {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return _this7.form.post('api/customers' + '?token=' + _this7.$store.state.token).then(function () {
                  _this7.$toastr.success('Account created successfully', 'Success');
                  _this7.dialog = false;
                  Fire.$emit("createCustomerEvent");
                  _this7.form.reset();
    ...
    updateCustomer: function updateCustomer(item) {
      var _this8 = this;
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this8.form.put("api/Customers/" + _this8.form.id + '?token=' + _this8.$store.state.token).then(function () {
            _this8.$toastr.success("Customer updated successfully", "Success");
            Fire.$emit("updatedCustomerEvent"); //update an event
            _this8.dialog = false;
          })["catch"](function (error) {
            _this8.btn = "Updating Customer";
            _this8.btn2 = "";
            _this8.$toastr.error("Can not update Customer information", "Error");
          });
        }
      });
    },
    deleteCustomer: function deleteCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this9.form["delete"]("api/Customers/" + item.id + '?token=' + _this9.$store.state.token).then(function () {
            Swal.fire("Deleted!", "Record has been deleted.", "success");
            Fire.$emit("DeleteCustomerEvent"); //delete  an event
          })["catch"](function (error) {
            Swal.fire({
              icon: "error",
              title: error,
  ...
  created: function created() {
    ...
    Fire.$on(["createCustomerEvent", "DeleteCustomerEvent", "updatedCustomerEvent"], function () {
      //listen to  events
      _this10.getAllCustomers();
    });
  }
});
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Customer_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Customer.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/views/pages/Customer.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Customer_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
