  ...
  methods: {
    ...
    updateStaff: function updateStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this5.form.put("api/staffs/" + _this5.form.id + '?token=' + _this5.$store.state.token).then(function () {
            _this5.$toastr.success("Staff updated successfully", "Success");
            Fire.$emit("updatedStaffEvent"); //update an event
            _this5.dialog = false;
          })["catch"](function (error) {
            _this5.btn = "Updating Staff";
            _this5.btn2 = "";
            _this5.$toastr.error("Can not update Staff information", "Error");
          });
        }
      });
    },
    deleteStaff: function deleteStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this6.form["delete"]("api/staffs/" + item.id + '?token=' + _this6.$store.state.token).then(function () {
    ...
    removeAllStaff: function removeAllStaff() {},
    ...
    selectPhoto: function selectPhoto(e) {
      ...
      reader.onloadend = function (file) {
        ...
        _this7.form.passport = reader.result;
      };
...
/***/ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=0&blockType=v-card":
/*!****************************************************************************************!*\
  !*** ./resources/js/src/views/pages/user.vue?vue&type=custom&index=0&blockType=v-card ***!
  \****************************************************************************************/
/***/ (function() {
...
/***/ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=1&blockType=v-row&class=list%20px-3%20mx-auto":
/*!*******************************************************************************************************************!*\
  !*** ./resources/js/src/views/pages/user.vue?vue&type=custom&index=1&blockType=v-row&class=list%20px-3%20mx-auto ***!
  \*******************************************************************************************************************/
/***/ (function() {
...
/***/ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=2&blockType=v-card-title":
/*!**********************************************************************************************!*\
  !*** ./resources/js/src/views/pages/user.vue?vue&type=custom&index=2&blockType=v-card-title ***!
  \**********************************************************************************************/
/***/ (function() {
...
/***/ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=3&blockType=v-simple-table&height=250&fixed-header=true":
/*!*****************************************************************************************************************************!*\
  !*** ./resources/js/src/views/pages/user.vue?vue&type=custom&index=3&blockType=v-simple-table&height=250&fixed-header=true ***!
  \*****************************************************************************************************************************/
/***/ (function() {
...
/* harmony import */ var _user_vue_vue_type_custom_index_0_blockType_v_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./user.vue?vue&type=custom&index=0&blockType=v-card */ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=0&blockType=v-card");
/* harmony import */ var _user_vue_vue_type_custom_index_0_blockType_v_card__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_user_vue_vue_type_custom_index_0_blockType_v_card__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _user_vue_vue_type_custom_index_1_blockType_v_row_class_list_20px_3_20mx_auto__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user.vue?vue&type=custom&index=1&blockType=v-row&class=list%20px-3%20mx-auto */ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=1&blockType=v-row&class=list%20px-3%20mx-auto");
/* harmony import */ var _user_vue_vue_type_custom_index_1_blockType_v_row_class_list_20px_3_20mx_auto__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_user_vue_vue_type_custom_index_1_blockType_v_row_class_list_20px_3_20mx_auto__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _user_vue_vue_type_custom_index_2_blockType_v_card_title__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user.vue?vue&type=custom&index=2&blockType=v-card-title */ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=2&blockType=v-card-title");
/* harmony import */ var _user_vue_vue_type_custom_index_2_blockType_v_card_title__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_user_vue_vue_type_custom_index_2_blockType_v_card_title__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _user_vue_vue_type_custom_index_3_blockType_v_simple_table_height_250_fixed_header_true__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./user.vue?vue&type=custom&index=3&blockType=v-simple-table&height=250&fixed-header=true */ "./resources/js/src/views/pages/user.vue?vue&type=custom&index=3&blockType=v-simple-table&height=250&fixed-header=true");
/* harmony import */ var _user_vue_vue_type_custom_index_3_blockType_v_simple_table_height_250_fixed_header_true__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_user_vue_vue_type_custom_index_3_blockType_v_simple_table_height_250_fixed_header_true__WEBPACK_IMPORTED_MODULE_7__);
...
/* custom blocks */
;
if (typeof (_user_vue_vue_type_custom_index_0_blockType_v_card__WEBPACK_IMPORTED_MODULE_4___default()) === 'function') _user_vue_vue_type_custom_index_0_blockType_v_card__WEBPACK_IMPORTED_MODULE_4___default()(component)
;
if (typeof (_user_vue_vue_type_custom_index_1_blockType_v_row_class_list_20px_3_20mx_auto__WEBPACK_IMPORTED_MODULE_5___default()) === 'function') _user_vue_vue_type_custom_index_1_blockType_v_row_class_list_20px_3_20mx_auto__WEBPACK_IMPORTED_MODULE_5___default()(component)
;
if (typeof (_user_vue_vue_type_custom_index_2_blockType_v_card_title__WEBPACK_IMPORTED_MODULE_6___default()) === 'function') _user_vue_vue_type_custom_index_2_blockType_v_card_title__WEBPACK_IMPORTED_MODULE_6___default()(component)
;
if (typeof (_user_vue_vue_type_custom_index_3_blockType_v_simple_table_height_250_fixed_header_true__WEBPACK_IMPORTED_MODULE_7___default()) === 'function') _user_vue_vue_type_custom_index_3_blockType_v_simple_table_height_250_fixed_header_true__WEBPACK_IMPORTED_MODULE_7___default()(component)
...
_node_modules_vuetify_loader_lib_runtime_installComponents_js__WEBPACK_IMPORTED_MODULE_8___default()(component, {VAlert: vuetify_lib_components_VAlert__WEBPACK_IMPORTED_MODULE_9__["default"],VBtn: vuetify_lib_components_VBtn__WEBPACK_IMPORTED_MODULE_10__["default"],VCard: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_11__["default"],VCardActions: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_12__.VCardActions,VCardText: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_12__.VCardText,VCardTitle: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_12__.VCardTitle,VCol: vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_13__["default"],VContainer: vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_14__["default"],VDialog: vuetify_lib_components_VDialog__WEBPACK_IMPORTED_MODULE_15__["default"],VFileInput: vuetify_lib_components_VFileInput__WEBPACK_IMPORTED_MODULE_16__["default"],VForm: vuetify_lib_components_VForm__WEBPACK_IMPORTED_MODULE_17__["default"],VImg: vuetify_lib_components_VImg__WEBPACK_IMPORTED_MODULE_18__["default"],VProgressCircular: vuetify_lib_components_VProgressCircular__WEBPACK_IMPORTED_MODULE_19__["default"],VRow: vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_20__["default"],VSpacer: vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_21__["default"]})
