...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    view: function view(item) {
      ...
      this.state_of_origin = function () {
        return _this4.states.filter(function (item) {
          return _this4.states.includes(item.customer_contact.state_of_residence_id);
        });
      };
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getStates").then(function (response) {
                  _this5.states = response.data.states;
                })["catch"](function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllCustomers' + '?token=' + _this6.$store.state.token).then(function (response) {
                  _this6.allCustomers = response.data.allCustomers;
                  _this6.allCustomer2 = response.data.allCustomers2;
                  _this6.totalCustomers = response.data.totalCustomers;
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
              case 2:
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                .then(function (response) {
                  ...
                  _this7.$toastr.error("search failed", "Error");
                });
              case 3:
              case "end":
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return _this8.form.post('api/customers' + '?token=' + _this8.$store.state.token).then(function () {
                  _this8.$toastr.success('Account created successfully', 'Success');
                  _this8.dialog = false;
    ...
    updateCustomer: function updateCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this9.form.put("api/customers/" + _this9.form.id + '?token=' + _this9.$store.state.token).then(function () {
            _this9.$toastr.success("Customer updated successfully", "Success");
            Fire.$emit("updatedCustomerEvent"); //update an event
            _this9.dialog = false;
          })["catch"](function (error) {
            _this9.btn = "Updating Customer";
            _this9.btn2 = "";
            _this9.$toastr.error("Can not update Customer information", "Error");
          });
        }
      });
    },
    deleteCustomer: function deleteCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this10.form["delete"]("api/customers/" + item.id + '?token=' + _this10.$store.state.token).then(function () {
