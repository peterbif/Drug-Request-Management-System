...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    stateOfResidence: function stateOfResidence(item) {
      var index = this.states.findIndex(function (obj) {
        return obj.id === item.customer_contact.state_of_residence_id;
      });
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                .then(function (response) {
                  _this6.allCustomers = response.data.allCustomers;
                })["catch"](function () {
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _this7.form.post('api/customers' + '?token=' + _this7.$store.state.token).then(function () {
                  _this7.$toastr.success('Customer created successfully', 'Success');
                  _this7.dialog = false;
