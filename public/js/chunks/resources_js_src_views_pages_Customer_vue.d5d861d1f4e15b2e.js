  ...
  data: function data() {
    return {
      ...
      passwordRules: [function (v) {
        ...
        return v && v.length >= 8 || 'Passworfd must be minimum of 8 characters';
      }
      // value => {
  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllCustomers").then(function (response) {
                  _this2.allCustomer = response.data.allCustomer;
                  _this2.allCustomer2 = response.data.allCustomer2;
                  _this2.totalCustomer = response.data.totalCustomer;
    ...
    updateCustomer: function updateCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this5.spinnerLoading = true;
          _this5.form.put("api/Customers/" + _this5.form.id + '?token=' + _this5.$store.state.token).then(function () {
            _this5.$toastr.success("Customer updated successfully", "Success");
            Fire.$emit("updatedCustomerEvent"); //update an event
            _this5.dialog = false;
          })["catch"](function (error) {
            _this5.btn = "Updating Customer";
            _this5.btn2 = "";
            _this5.$toastr.error("Can not update Customer information", "Error");
          });
        }
      });
    },
    deleteCustomer: function deleteCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this6.form["delete"]("api/Customers/" + item.id + '?token=' + _this6.$store.state.token).then(function () {
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c("v-autocomplete", {
                                        ...
                                        model: {
                                          value: _vm.form.Customer_category_id,
                                          callback: function ($$v) {
                                            _vm.$set(
                                              _vm.form,
                                              "Customer_category_id",
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm.form.errors.has("secret_question_id")
                                        ? _c(
                                            "v-alert",
                                            {
                                              attrs: {
...
/* harmony import */ var vuetify_lib_components_VDataTable__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! vuetify/lib/components/VDataTable */ "./node_modules/vuetify/lib/components/VDataTable/VSimpleTable.js");
