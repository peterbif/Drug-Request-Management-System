  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllStaff").then(function (response) {
                  ...
                  _this3.allStaff2 = response.data.allstaff2;
                  _this3.totalStaff = response.data.totalStaff;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                .then(function (response) {
                  _this4.allStaff = response.data.allStaff;
                })["catch"](function () {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _this6.form;
              case 2:
                _this6.form.post("api/uploadPassport/" + '?token=' + _this6.$store.state.token).then(function () {
                  _this6.$toastr.success('Passport uploaded successfully', 'Success');
                  _this6.dialog2 = false;
                  Fire.$emit("createdStaffEvent");
                  _this6.form.reset();
                })["catch"](function (error) {
    ...
    updateStaff: function updateStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this7.form.put("api/staffs/" + _this7.form.id + '?token=' + _this7.$store.state.token).then(function () {
            _this7.$toastr.success("Staff updated successfully", "Success");
            Fire.$emit("updatedStaffEvent"); //update an event
            _this7.dialog = false;
          })["catch"](function (error) {
            _this7.btn = "Updating Staff";
            _this7.btn2 = "";
            _this7.$toastr.error("Can not update Staff information", "Error");
          });
        }
      });
    },
    deleteStaff: function deleteStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this8.form["delete"]("api/staffs/" + item.id + '?token=' + _this8.$store.state.token).then(function () {
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllStaffCategories").then(function (response) {
                  _this9.staff_categories = response.data.allStaffCategories;
                  // response.data.allStaffCategories.forEach((Object) => {
                  //   this.staff_categories.push({ value: Object.id, label: Object.name});
                  // });
                })["catch"](function () {
            ...
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/allSecretQuestions").then(function (response) {
                  _this10.allSecretQuestions = response.data.allSecretQuestions;
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
              case 2:
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("div", { staticClass: "mb-6" }, [
                                        _vm._v("Active picker: "),
                                        _c("code", [
                                          _vm._v(
                                            _vm._s(_vm.activePicker || "null")
                                          ),
                                        ]),
                                      ]),
                                      _vm._v(" "),
