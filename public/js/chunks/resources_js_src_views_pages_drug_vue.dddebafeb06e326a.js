...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      brandnameRules: [function (v) {
        return !!v || 'brandname is required';
      }, function (v) {
        return v && v.length <= 199 || 'brandname must be less than 199 characters';
      }],
      strength: [function (v) {
