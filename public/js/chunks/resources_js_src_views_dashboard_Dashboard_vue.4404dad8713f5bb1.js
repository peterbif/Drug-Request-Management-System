...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var totalProfit = {
      ...
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiPoll,
      color: 'success',
    ...
    var totalSales = {
      statTitle: 'Refunds',
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiCurrencyUsd,
      color: 'secondary',
      subtitle: 'Past Month',
      statistics: '$78',
      change: '-15%'
    ...
    var newProject = {
      ...
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiLabelVariantOutline,
      color: 'primary',
    ...
    var salesQueries = {
      ...
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiHelpCircleOutline,
      color: 'warning',
      subtitle: 'Last week',
      statistics: '15',
      change: '-18%'
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios.post('api/getAllWeddings' + '?token=' + _this2.$store.state.token).then(function (response) {
