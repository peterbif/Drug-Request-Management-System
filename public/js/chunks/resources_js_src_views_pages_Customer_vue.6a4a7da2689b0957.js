...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      //     { text: "Customer Category", value: "Customer_category_id", sortable: false },
  ...
  setup: function setup() {
    ...
    var Customer_categories = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)([]);
    var socialLink = [{
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllCustomers").then(function (response) {
                  _this4.allCustomer = response.data.allCustomer;
                  _this4.allCustomer2 = response.data.allCustomer2;
                  _this4.totalCustomer = response.data.totalCustomer;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                query = _this5.search;
                _context2.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/search/Customer?s=' + query)
                // .get('api/auth/findDesignation?q='+ query + '&token=' + this.$store.state.token )
                .then(function (response) {
                  _this5.allCustomer = response.data.allCustomer;
                })["catch"](function () {
                  _this5.$toastr.error("search failed", "Error");
                });
              case 3:
              case "end":
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return _this6.form.post('/api/auth/register').then(function () {
                  _this6.$toastr.success('Account created successfully', 'Success');
                  _this6.dialog = false;
                  Fire.$emit("createCustomerEvent");
                  _this6.form.reset();
                })["catch"](function (error) {
                  _this6.progress = true;
                  _this6.$toastr.error('Can not create an Account', error);
                });
              case 3:
              case "end":
    ...
    updateCustomer: function updateCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this7.form.put("api/Customers/" + _this7.form.id + '?token=' + _this7.$store.state.token).then(function () {
            _this7.$toastr.success("Customer updated successfully", "Success");
            Fire.$emit("updatedCustomerEvent"); //update an event
            _this7.dialog = false;
          })["catch"](function (error) {
            _this7.btn = "Updating Customer";
            _this7.btn2 = "";
            _this7.$toastr.error("Can not update Customer information", "Error");
          });
        }
      });
    },
    deleteCustomer: function deleteCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this8.form["delete"]("api/Customers/" + item.id + '?token=' + _this8.$store.state.token).then(function () {
