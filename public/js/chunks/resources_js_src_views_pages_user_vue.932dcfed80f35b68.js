      ...
      scopedSlots: _vm._u([
        {
          ...
          fn: function () {
            return [
              ...
              _c(
                "tbody",
                _vm._l(_vm.allStaff, function (item) {
                  return _c("tr", { key: item.id }, [
                    _c("td", [_vm._v(_vm._s(item.surname))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(item.staff_category_id))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(item.email))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(item.phone_no))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(item.surname))]),
                    _vm._v(" "),
                    _c("td"),
