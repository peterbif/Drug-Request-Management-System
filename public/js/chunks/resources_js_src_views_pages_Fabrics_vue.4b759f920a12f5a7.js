  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllCustomers' + '?token=' + _this2.$store.state.token).then(function (response) {
                  _this2.allCustomers = response.data.allCustomers;
                })["catch"](function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllFabricss' + '?token=' + _this3.$store.state.token).then(function (response) {
                  _this3.allFabricss = response.data.allFabricss;
                  _this3.allFabrics2 = response.data.allFabricss2;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                query = _this4.search;
                _this4.form.post('/api/search/Fabrics')
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _this5.form.grand_price = parseFloat(_this5.form.grand_price);
                _this5.form.payment = parseFloat(_this5.form.payment);
                _context4.next = 5;
                return _this5.form.post('api/Fabricss' + '?token=' + _this5.$store.state.token).then(function () {
    ...
    updateFabrics: function updateFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this6.form.put('api/Fabricss/' + _this6.form.id + '?token=' + _this6.$store.state.token).then(function () {
            _this6.$toastr.success('Fabrics updated successfully', 'Success');
            Fire.$emit('updatedFabricsEvent'); //update an event
            _this6.dialog = false;
          })["catch"](function (error) {
            _this6.btn = 'Updating Fabrics';
            _this6.btn2 = '';
            _this6.$toastr.error('Can not update Fabrics information', 'Error');
          });
        }
      });
    },
    deleteFabrics: function deleteFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this7.form["delete"]('api/Fabricss/' + item.id + '?token=' + _this7.$store.state.token).then(function () {
