...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    passwordConfirmationRule: function passwordConfirmationRule() {
      var _this = this;
      return function () {
        return _this.form.password === _this.form.confirm_password || "Password must match";
      };
    }
  },
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/allSecretQuestions").then(function (response) {
                  _this2.allSecretQuestions = response.data.allSecretQuestions;
                })["catch"](function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _this3.form.post('api/auth/resetPassword').then(function (response) {
                  if (response.data.status) {
                    _this3.$store.commit('setToken', response.data.token);
                    _this3.$toastr.success("resetpassword successfully", "Success");
                    _this3.$router.push('/dashboard');
                    _this3.form.reset();
                  }
                })["catch"](function (error) {
                  // this.spinnerLoading = true;
                  _this3.$toastr.error("Can not resetpassword", error);
                });
              case 3:
              case "end":
                      ...
                      _c(
                        "v-btn",
                        {
                          ...
                          attrs: {
                            ...
                            color: "primary",
                            disabled: !(
                              _vm.form.email & _vm.form.secret_question_id &&
                              _vm.form.answer &&
                              _vm.form.password &&
