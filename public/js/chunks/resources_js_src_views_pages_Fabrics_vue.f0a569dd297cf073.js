  ...
  methods: {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('/api/allStatuses').then(function (response) {
                  _this3.statuses = response.data.allStatuses;
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
              case 2:
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllCustomers' + '?token=' + _this4.$store.state.token).then(function (response) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/getAllFabricss' + '?token=' + _this5.$store.state.token).then(function (response) {
                  _this5.allFabricss = response.data.allFabricss;
                  _this5.allFabrics2 = response.data.allFabricss2;
                  _this5.totalFabricss = response.data.totalFabricss;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                query = _this6.search;
                _this6.form.post('/api/search/Fabrics')
                // .get('api/auth/findDesignation?q='+ query + '&token=' + this.$store.state.token )
                .then(function (response) {
                  _this6.allFabricss = response.data.allFabricss;
                  _this6.allFabrics2 = response.data.allFabricss2;
                  _this6.totalFabricss = response.data.totalFabricss;
                  // this.amounts = response.data.amount;
                })["catch"](function () {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 5;
                return _this7.form.post('api/Fabricss' + '?token=' + _this7.$store.state.token).then(function () {
    ...
    updateFabrics: function updateFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this8.form.put('api/Fabricss/' + _this8.form.id + '?token=' + _this8.$store.state.token).then(function () {
            _this8.$toastr.success('Fabrics updated successfully', 'Success');
            Fire.$emit('updatedFabricsEvent'); //update an event
            _this8.dialog = false;
          })["catch"](function (error) {
            _this8.btn = 'Updating Fabrics';
            _this8.btn2 = '';
            _this8.$toastr.error('Can not update Fabrics information', 'Error');
          });
        }
      });
    },
    deleteFabrics: function deleteFabrics(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this9.form["delete"]('api/Fabricss/' + item.id + '?token=' + _this9.$store.state.token).then(function () {
