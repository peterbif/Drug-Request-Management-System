...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      date_of_resumption: false,
      columns: [{
        label: "Surname",
        field: "allstaff.surname"
      }, {
        label: "Firstname",
        field: "allstaff.firstname"
      }, {
        label: "Staff Category",
        field: "allstaff.staffcategory.name"
      }, {
        label: "Email",
        field: "allstaff.email"
      }, {
        label: "Phone No",
        field: "allstaff.phone_no"
      }],
      btn: "",
      btn2: "",
      dialog: false,
      ...
      form: new Form({
        ...
        date_of_resumption: new Date(Date.now() - new Date().getTimezoneOffset() * 60000).toISOString().substr(0, 10)
      })
    };
  },
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllStaff").then(function (response) {
                  ...
                  _this2.columns = response.data.allstaff2;
                                        ...
                                        directives: [
                                          {
                                            name: "show",
                                            rawName: "v-show",
                                            value: _vm.date_of_resumption,
                                            expression: "date_of_resumption",
                                          },
                                        ],
                                        staticClass: "mb-3",
                                        attrs: {
                                          hint: "Date of Resumption as a Staffer",
                                          required: "",
                                          rules: _vm.dateOfResumptionRule,
                                        },
                                        model: {
                                          value: _vm.form.date_of_resumption,
                                          callback: function ($$v) {
                                            _vm.$set(
                                              _vm.form,
                                              "date_of_resumption",
                                          ...
                                          expression: "form.date_of_resumption",
                                        },
                                      }),
                                    ],
                                    1
