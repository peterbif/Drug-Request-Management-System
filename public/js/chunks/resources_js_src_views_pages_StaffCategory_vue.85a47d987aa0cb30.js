...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/allStaffCategory" + '?token=' + _this.$store.state.token).then(function (response) {
    ...
    CreateNewStaffCategory: function CreateNewStaffCategory() {},
    CreateNewStaffCategory2: function CreateNewStaffCategory2() {
      var _this3 = this;
    ...
    updateStaffCategory: function updateStaffCategory() {
      var _this4 = this;
      Swal.fire({
                        ...
                        "v-btn",
                        {
                          ...
                          on: {
                            click: function ($event) {
                              ...
                              _vm.editMode
                                ? _vm.updateStaffCategory()
                                : _vm.CreateNewStaffCategory()
                            },
                          },
                        },
                        [
