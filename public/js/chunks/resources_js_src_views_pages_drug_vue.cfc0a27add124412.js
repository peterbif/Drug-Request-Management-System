          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _this7.formData.append('name', _this7.fileName);
                _this7.formData.append('file', _this7.$refs.file.files[0]);
                _context4.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().post('/api/importFile', _this7.formData).then(function (response) {
