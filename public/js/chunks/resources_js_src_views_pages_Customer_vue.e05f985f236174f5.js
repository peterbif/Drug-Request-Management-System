...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    view: function view(item) {
      ...
      this.state_of_residence = this.states.includes(item.customer_contact.state_of_residence_id);
      this.state_of_origin = this.states.includes(item.customer_contact.state_of_origin_id);
