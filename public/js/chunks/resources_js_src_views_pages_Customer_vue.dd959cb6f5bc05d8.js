  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllCustomers").then(function (response) {
                  _this3.allCustomer = response.data.allCustomer;
                  _this3.allCustomer2 = response.data.allCustomer2;
                  _this3.totalCustomer = response.data.totalCustomer;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                .then(function (response) {
                  ...
                  _this4.$toastr.error("search failed", "Error");
                });
              case 3:
              case "end":
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this5.$refs.form.validate();
                _context3.next = 3;
                return _this5.form.post('/api/auth/register').then(function () {
                  _this5.$toastr.success('Account created successfully', 'Success');
                  _this5.dialog = false;
    ...
    updateCustomer: function updateCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this6.form.put("api/Customers/" + _this6.form.id + '?token=' + _this6.$store.state.token).then(function () {
            _this6.$toastr.success("Customer updated successfully", "Success");
            Fire.$emit("updatedCustomerEvent"); //update an event
            _this6.dialog = false;
          })["catch"](function (error) {
            _this6.btn = "Updating Customer";
            _this6.btn2 = "";
            _this6.$toastr.error("Can not update Customer information", "Error");
          });
        }
      });
    },
    deleteCustomer: function deleteCustomer(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          _this7.form["delete"]("api/Customers/" + item.id + '?token=' + _this7.$store.state.token).then(function () {
