...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var Order_categories = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)([]);
    var socialLink = [{
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllCustomers' + '?token=' + _this4.$store.state.token).then(function (response) {
                  _this4.allCustomers = response.data.allCustomers;
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
              case 2:
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllOrders' + '?token=' + _this5.$store.state.token).then(function (response) {
                  _this5.allOrders = response.data.allOrders;
                  _this5.allOrder2 = response.data.allOrders2;
                  _this5.totalOrders = response.data.totalOrders;
                })["catch"](function () {
                  // this.$toastr.error("Can not load status", "Error");
                });
              case 2:
    ...
    //   await axios.get('api/getAllCustomers'+'?token='+this.$store.state.token)
    //     .then((response) => {
    //        this.allOrders = response.data.allCustomers;
    //     })
    //     .catch(() => {
    //       // this.$toastr.error("Can not load status", "Error");
    //     });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                query = _this6.search;
                _context4.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/search/Order?s=' + query)
    ...
    updateOrder: function updateOrder(item) {
      var _this8 = this;
      Swal.fire({
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    { attrs: { cols: "12", sm: "6", md: "6" } },
                                    [
                                      _vm.form.errors.has("fabrics_name")
                                        ? _c(
                                            "v-alert",
                                            {
                                              attrs: {
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    [
                                      _vm.form.errors.has("measurement")
                                        ? _c(
                                            "v-alert",
                                            {
                                              attrs: {
                                      ...
                                      _c("v-textarea", {
                                        ...
                                        attrs: {
                                          ...
                                          rules: function (v) {
                                            return (
                                              !!v || "Measurement is required"
                                            )
                                          },
                                          counter: 255,
                                        },
                                        model: {
                                          value: _vm.form.measurement,
                                          callback: function ($$v) {
                                            _vm.$set(
                                              _vm.form,
                                              "measurement",
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c(
                                    ...
                                    { attrs: { cols: "12", sm: "6", md: "6" } },
                                    [
                                      _vm.form.errors.has("staff_assigned_id")
                                        ? _c(
                                            "v-alert",
                                            {
                                              attrs: {
                                      ...
                                      _c("v-autocomplete", {
                                        ...
                                        model: {
                                          value: _vm.form.staff_assigned_id,
                                          callback: function ($$v) {
                                            _vm.$set(
                                              _vm.form,
                                              "staff_assigned_id",
                                          ...
                                          expression: "form.staff_assigned_id",
                                        },
                                      }),
                                    ],
                                    1
