...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _this5.form.post('api/fabricss' + '?token=' + _this5.$store.state.token).then(function () {
                  _this5.$toastr.success('Fabrics created successfully', 'Success');
                  _this5.dialog = false;
                  Fire.$emit('createFabricsEvent');
                  _this5.form.reset();
                })["catch"](function (error) {
                  _this5.progress = true;
                  _this5.$toastr.error('Can not create fabrics', error);
                });
              case 3:
              case "end":
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this6.form.put('api/Fabricss/' + _this6.form.id + '?token=' + _this6.$store.state.token).then(function () {
            ...
            _this6.btn2 = '';
            _this6.$toastr.error('Can not update Fabrics details', 'Error');
          });
        }
      });
    },
    deleteFabrics: function deleteFabrics(item) {
      ...
      Swal.fire({
        title: 'Are you sure?',
        text: item.fabrics_name + ' will be deleted permanently' + " and it won't be reverted!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
