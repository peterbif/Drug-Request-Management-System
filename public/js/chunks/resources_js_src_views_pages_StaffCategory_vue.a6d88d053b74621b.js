...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    allStaffCategoryCategory: function allStaffCategoryCategory() {
      var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/allStaffCategoryCategory").then(function (response) {
                  _this.allStaffCategory = response.data.allStaffCategory;
                  _this.totalStaff = response.data.totalStaff;
                  // response.data.  allStaffCategoryCategories.forEach((Object) => {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                query = _this2.search;
                _context2.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/search/staffCategory?s=' + query).then(function (response) {
    ...
    } // async   get  allStaffCategoryCategoryCategories() {
    //   await axios.get("/api/getallStaffCategoryCategoryCategories")
    //     .then((response) => {
    //        this.staff_categories = response.data.  allStaffCategoryCategories;
    //     })
    //     .catch(() => {
    //       // this.$toastr.error("Can not load status", "Error");
    //     });
