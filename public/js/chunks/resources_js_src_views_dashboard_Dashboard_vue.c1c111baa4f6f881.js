...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var totalProfit = {
      ...
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiPoll,
      color: 'success',
    ...
    var totalSales = {
      statTitle: 'Refunds',
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiCurrencyUsd,
      color: 'secondary',
      subtitle: 'Past Month',
      statistics: '$78',
      change: '-15%'
    ...
    var newProject = {
      ...
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiLabelVariantOutline,
      color: 'primary',
    ...
    var salesQueries = {
      ...
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiHelpCircleOutline,
      color: 'warning',
      subtitle: 'Last week',
      statistics: '15',
      change: '-18%'
