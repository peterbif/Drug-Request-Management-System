...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var staff_categories = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__.ref)([]);
    var socialLink = [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.get("/api/getAllStaffCategories").then(function (response) {
                  _this.staff_categories = response.data.allStaffCategories;
                  response.data.allStaffCategories.forEach(function (Object) {
                    _this.staff_categories.push({
                      value: Object.id,
                      label: Object.staff_category
                    });
                  });
                })["catch"](function () {
