...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      columns: [{
        ...
        field: "Drug_contact.presentation"
      }, {
        label: "Email",
        field: "Drug_contact.email"
      }, {
        label: "Phone No",
        field: "Drug_contact.phone_no"
      }],
      btn: "",
      btn2: "",
      dialog: false,
      ...
      nameRules: [function (v) {
        ...
        return v && v.length <= 199 || 'name must be less than 199 characters';
      }],
      brand_nameRules: [function (v) {
        return !!v || 'brand_name is required';
      }, function (v) {
        return v && v.length <= 199 || 'brand_name must be less than 199 characters';
      }],
      strength: [function (v) {
  ...
  methods: {
    ...
    view: function view(item) {
      this.dialog3 = true;
      this.form.fill(item);
      this.form.email = item.Drug_contact.email;
      this.form.phone_no = item.Drug_contact.phone_no;
      this.form.presentation = item.Drug_contact.presentation;
      this.form.state_of = item.Drug_contact.phone_no;
      this.form.phone_no = item.Drug_contact.phone_no;
      this.form.Drug_id = item.Drug_contact.id;
    },
    stateOfOrigin: function stateOfOrigin(item) {
      var index = this.statuses.findIndex(function (obj) {
        return obj.id === item.Drug_contact.state_of_origin_id;
      });
      return this.state_of_origin = this.statuses[index].state;
    },
    stateOfResidence: function stateOfResidence(item) {
      var index = this.statuses.findIndex(function (obj) {
        return obj.id === item.Drug_contact.status_id;
      });
      return this.state_of_residence = this.statuses[index].state;
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getstatuses").then(function (response) {
                  _this4.statuses = response.data.statuses;
                })["catch"](function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllDrugs' + '?token=' + _this5.$store.state.token).then(function (response) {
                  _this5.allDrugs = response.data.allDrugs;
                  _this5.allDrug2 = response.data.allDrugs2;
    ...
    editDrug: function editDrug(item) {
      ...
      this.form.phone_no = item.Drug_contact.phone_no;
      this.form.presentation = item.Drug_contact.presentation;
      this.form.status_id = item.Drug_contact.status_id;
      this.form.state_of_origin_id = item.Drug_contact.state_of_origin_id;
      this.form.Drug_id = item.Drug_contact.id;
      this.dialog = true;
    },
        ...
        scopedSlots: _vm._u([
          {
            ...
            fn: function () {
              return [
                ...
                _c(
                  "tbody",
                  _vm._l(_vm.allDrugs, function (item, index) {
                    return _c("tr", { key: item.id }, [
                      ...
                      _c("td", { staticClass: "text-left" }, [
                        _vm._v(_vm._s(item.Drug_contact.email)),
                      ]),
                      _vm._v(" "),
                      _c("td", { staticClass: "text-left" }, [
                        _vm._v(_vm._s(item.Drug_contact.phone_no)),
                      ]),
                      _vm._v(" "),
                      _c(
                        "td",
