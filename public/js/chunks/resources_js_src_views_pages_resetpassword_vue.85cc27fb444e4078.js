...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    }, (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref, "passwordRules", [function (v) {
      return !!v || "Password is required";
    },
    ...
    }]), (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref, "confirmPasswordRules", [function (v) {
      return !!v || "Password Confrimation  is required";
    }]), (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref, "answerRules", [function (v) {
      return !!v || 'Answer to the  secret question is required';
    }]), (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref, "form", new Form({
      password: "",
      secret_question_id: "",
      answer: ""
    })), _ref;
  ...
  setup: function setup() {
    ...
    var email = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)('');
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/allSecretQuestions").then(function (response) {
                  _this.allSecretQuestions = response.data.allSecretQuestions;
                })["catch"](function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _this2.form.post('api/auth/login').then(function (response) {
                  if (response.data.status) {
                    _this2.$store.commit('setToken', response.data.token);
                    _this2.$toastr.success("login successfully", "Success");
                    _this2.$router.push('/dashboard');
                    _this2.form.reset();
                  }
                })["catch"](function (error) {
                  // this.spinnerLoading = true;
                  _this2.$toastr.error("Can not login", error);
                });
              case 3:
              case "end":
