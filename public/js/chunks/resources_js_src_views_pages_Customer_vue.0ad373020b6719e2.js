...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      columns: [{
        ...
        field: "customer_contact.contact_address"
      }, {
        label: "Email",
  ...
  methods: {
    ...
    stateOfOrigin: function stateOfOrigin(item) {
      var index = this.states.findIndex(function (obj) {
        return obj.id === item.customer_contact.state_of_origin_id;
      });
      return this.state_of_origin = this.states[index].state;
    },
    stateOfResidence: function stateOfResidence(item) {
      var values = this.states.map(function (item) {
        return item.customer_contact.state_of_residence_id;
      });
      this.state_of_residence = values;
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get('api/getAllCustomers' + '?token=' + _this5.$store.state.token).then(function (response) {
                  _this5.allCustomers = response.data.allCustomers;
                  _this5.allCustomer2 = response.data.allCustomers2;
    ...
    editCustomer: function editCustomer(item) {
      ...
      this.form.state_of_origin_id = item.customer_contact.state_of_origin_id;
      this.form.customer_id = item.customer_contact.id;
      this.dialog = true;
    },
