...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      nameRules: [function (v) {
        return !!v || 'Staff Category is required';
      }, function (v) {
        return v && v.length <= 100 || 'Staff Category must be less than 199 characters';
      }],
      progress: false,
      totalStaff:  false || 0,
      form: new Form({
  ...
  methods: (_methods = {
    allStaffCategories: function allStaffCategories() {
      var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/allStaffCategory" + '?token=' + _this.$store.state.token).then(function (response) {
                  _this.allStaffCategory = response.data.allStaffCategory;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                query = _this2.search;
                _context2.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get('/api/search/staffCategory?s=' + query).then(function (response) {
                  _this2.allStaffCategory = response.data.allStaffCategory;
                })["catch"](function () {
  ...
  }, (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "createstaff", function createstaff() {
    var _this3 = this;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _this3.form.post('/api/staffCategory' + '?token=' + _this3.$store.state.token).then(function () {
  ...
  }), (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "editStaff", function editStaff(item) {
    this.editMode = true;
    this.form.reset();
    ...
    // this.btnName = "Update";
  }), (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "updateStaff", function updateStaff(item) {
    var _this4 = this;
    Swal.fire({
      ...
      if (result.value) {
        ...
        _this4.form.put("api/staffCategory/" + _this4.form.id + '?token=' + _this4.$store.state.token).then(function () {
  ...
  }), (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "deleteStaff", function deleteStaff(item) {
    var _this5 = this;
    Swal.fire({
      title: "Are you sure?",
      ...
      if (result.value) {
        _this5.form["delete"]("api/staffCategory/" + item.id + '?token=' + _this5.$store.state.token).then(function () {
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "v-btn",
                        {
                          attrs: { color: "primary", disabled: !_vm.form.name },
                          on: {
                            click: function ($event) {
