            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/getAllStaffCategories").then(function (response) {
                  _this.staff_categories = response.data.allStaffCategories;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.spinnerLoading = true;
                _context2.next = 3;
                return _this2.form.post('/api/auth/register').then(function () {
