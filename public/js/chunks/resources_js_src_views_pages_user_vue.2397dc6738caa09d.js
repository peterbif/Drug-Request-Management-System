...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    headers: function headers() {
      return [{
        ...
        sortable: false,
        value: 'passport'
      }, (0,_var_www_html_tailor_inventory_system_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({
        text: 'Fullname',
        value: 'surname'
      }, "value", 'firstname'), {
        text: 'Staff Category',
  ...
  methods: {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                .then(function (response) {
                  _this3.depts = response.data.data;
                })["catch"](function () {
    ...
    updateStaff: function updateStaff(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          _this5.form.put("api/auth/staffs/" + item.id + '?token=' + _this5.$store.state.token).then(function () {
            _this5.$toastr.success("dept updated successfully", "Success");
            Fire.$emit("updatedeptEvent"); //update an event
            _this5.hideModal();
            _this5.spinnerLoading = false;
            // window.location="/dept";
          })["catch"](function (error) {
            _this5.btn = "Updating dept";
            _this5.spinnerLoading = true;
            _this5.btn2 = "";
            _this5.$toastr.error("Can not update dept information", "Error");
          });
        }
      });
    },
    deleteStaff: function deleteStaff(item) {
      ...
      Swal.fire({
        title: "Are you sure?",
        text: dept.department + " will be deleted permanently" + " and it won't be reverted!",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        ...
        if (result.value) {
          _this6.form["delete"]("api/auth/staffs/" + dept.id + '?token=' + _this6.$store.state.token).then(function () {
            Swal.fire("Deleted!", "Record has been deleted.", "success");
            Fire.$emit("DeletedeptEvent"); //delete  an event
          })["catch"](function (error) {
            Swal.fire({
              icon: "error",
              title: error,
  ...
  created: function created() {
    ...
    Fire.$on(["createdeptEvent", "DeletedeptEvent", "updatedeptEvent"], function () {
      //listen to  events
      _this10.getAllDepts();
      _this10.allDepts();
    });
