          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.form.email2 = _this.form.email;
                _context.next = 4;
                return _this.form.post("api/auth/generateAccessCodeForlogin").then(function (response) {
                  _this.message = response.data.message;
                  //  this.$progress.start();
                  _this.$toastr.success("Access code sent  to your email", "success");
                  ...
                  _this.$Progress.fail();
                  _this.spinnerLoading = true;
                  // this.$toastr.error("Can not generate Access Code", error);
                });
              case 4:
              case "end":
              ...
              case 0:
                ...
                return _this2.form.post('api/auth/login').then(function (response) {
                  if (response.data.success) {
                    ...
                    _this2.$store.commit("setHeadOfUnit", 0);
                    _this2.$store.commit("setHeadOfDept", 0);
                    $("#pin").modal("hide");

                    //  this.token = response.data.token; 
                    _this2.$toastr.success("login successfully", "Success");
                    _this2.spinnerLoading = false;
                    _this2.form.reset();
                    _this2.$router.push('/employeedashboard');
                  }
                })["catch"](function (error) {
                  _this2.spinnerLoading = true;
