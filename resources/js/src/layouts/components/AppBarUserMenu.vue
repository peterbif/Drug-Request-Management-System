    ...
    <v-list>
      <div class="pb-3 pt-2">
        ...
        <div class="d-inline-flex flex-column justify-center ms-3" style="vertical-align: middle">
          <span class="text--primary font-weight-semibold mb-n1"> {{surname}} {{firstname|initial}} </span>
      ...
      <v-list-item link>
        <v-list-item-icon class="me-2">
          <v-icon size="22" style="color:red">
  ...
  methods:{
    ...
    getUser() {
      axios
        ...
        .then((response) => {
          this.surname = response.data.user[0].surname;
